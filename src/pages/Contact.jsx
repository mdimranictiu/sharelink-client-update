...
const Contact = () => {
  ...
  return (
    <div className="mt-30 mx-auto px-10 min-h-screen">
      <h2 className="text-center font-bold text-3xl text-[#2A8AA4] ">Contact Us</h2>
      <div className="flex flex-col md:flex-row items-center gap-10 w-full">
        ...
        <div className="w-full md:w-1/2 bg-white p-6 rounded-lg shadow-xl">
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mb-4">
              <label className="block text-lg font-medium text-[#2A8AA4]">Name</label>
              <input 
            ...
            <div className="mb-4">
              <label className="block text-lg font-medium text-[#2A8AA4]">Email</label>
              <input 
            ...
            <div className="mb-4">
              <label className="block text-lg font-medium text-[#2A8AA4]">Message</label>
              <textarea 
